...
class Login extends Component {
	...
	render() {
		...
		return (
			<Layout bordered={false} style={{
				background: 'url(upm/login/img/login.jpg) top center no-repeat',
				backgroundSize: '100% 100%'
			}}>
				<Box region="center">
					<div className="centerContent">
						<div className="appTitle" style={{
							background: 'url(upm/login/img/login_title.png) top center no-repeat',
							backgroundSize: '100% 100%'
						}}></div>
						<Card bordered={false}>
							<Form onSubmit={action.handleSubmit.bind(this)} className="login-form" layout="horizontal">
								<FormItem>
									{getFieldDecorator('loginName', {
										...
										<Input addonBefore={<Icon type="user"/>} autoComplete="off" placeholder="用户名"
											   style={{width: 250}}/>
									)}
								</FormItem>
								<FormItem>
									{getFieldDecorator('password', {
										...
										<Input addonBefore={<Icon type="lock"/>} autoComplete="off" type="password"
											   placeholder="密码" style={{width: 250}}/>
									)}
								</FormItem>
								<Row>
									<Col span={17}>
										<FormItem>
											{getFieldDecorator('randomCode', {
												...
												<Input addonBefore={<Icon type="picture"/>} autoComplete="off"
													   placeholder="验证码"/>
											)}
										</FormItem>
									</Col>
									<Col span={7} style={{paddingLeft: 10}}>
										<img width="60px" height="30px" title="点击刷新验证码" src={this.state.verifyCodeSrc}
											 onClick={this.onClickVerifyCode.bind(this)}></img>
									</Col>
								</Row>
