...
class ModuleModal extends Component {
	...
	render() {
		let modalButtons = ([
			...
			<Button key="submit" type="primary" size="default" loading={this.props.loading}
					onClick={this.onOk.bind(this)}>保存</Button>]);
		...
		return (<Modal title={this.state.title} footer={modalButtons} visible={this.state.visible}
